...
class IsFavoriteColumn extends TableColumn
{
	...
	protected function getCellValue( Model $row, $decorator )
	{
		...
		{
			return '<a href="#" style="width: 100%; height: 100%; text-align: center" class="image-container" musicId="' . $row->MusicID . '"><img src="/static/image/songFavouriteSelect.png" style="width: 18px; height: 18px"/></a>';
		}
		else
		{
			return '<a href="#" class="image-container" musicId="' . $row->MusicID . '"><img src="/static/image/songFavouriteUnSelect.png" style="width: 18px; height: 18px"/></a>';
		}
	}
}